...
?><?php include 'header.php'; ?>
    ...
    <div class="relative bg-slate-900 text-white py-24 overflow-hidden border-b border-slate-800 text-center">
        ...
        <div class="absolute inset-0 z-0 pointer-events-none">
            <img src="assets/banner_slide_2.png" alt="Submit Manuscript Online" class="w-full h-full object-cover object-center opacity-30 scale-105 filter blur-[1px]">
                    ...
                    <div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <textarea name="abstract" required rows="5" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 focus:bg-white focus:ring-2 focus:ring-emerald-500 focus:border-transparent outline-none transition-all resize-none"></textarea>
                            </div>
