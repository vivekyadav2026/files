<?php include 'header.php'; ?>
    ...
    <div class="relative bg-emerald-900 text-white py-12 md:py-16 overflow-hidden border-b border-emerald-800 text-center">
        ...
        <div class="absolute inset-0 z-0 pointer-events-none">
            <img src="assets/banner_slide_2.png" alt="Farm Science Today" class="w-full h-full object-cover object-center opacity-25 scale-105 filter blur-[1px]">
        ...
        <div class="container mx-auto px-6 relative z-10">
            <nav class="flex justify-center mb-6 text-sm font-semibold text-emerald-400" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-2">
                    ...
                    <li aria-current="page" class="text-white">e-Magazine > About</li>
                </ol>
            </nav>
            <h1 class="text-4xl md:text-5xl font-bold mb-4 font-['Outfit'] tracking-tight text-white drop-shadow-md">Farm Science Today</h1>
            <p class="text-lg md:text-xl text-slate-300 max-w-3xl mx-auto font-light leading-relaxed drop-shadow">Presenting scientific knowledge in a simple, accessible style.</p>
        </div>
    </div>
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-tr-[4rem] rounded-bl-[4rem] shadow-2xl border-t-8 border-[#D4E157] relative overflow-hidden p-8 md:p-10 prose prose-emerald prose-lg prose-headings:font-['Oswald'] prose-headings:uppercase prose-headings:tracking-wide prose-headings:text-[#1B4332] max-w-none text-slate-600">
                        ...
                        <div class="not-prose flex flex-wrap gap-2 mt-4">
                            <span class="px-3 py-1 bg-[#f7f9f4] border border-slate-200 rounded-full text-xs text-slate-600">Agriculture</span>
                            ...
                            <span class="px-3 py-1 bg-[#f7f9f4] border border-slate-200 rounded-full text-xs text-slate-600">Plant Breeding</span>
                            ...
                            <span class="px-3 py-1 bg-[#f7f9f4] border border-slate-200 rounded-full text-xs text-slate-600">Forestry</span>
                        </div>
                    </div>
                </div>
