<?php include 'header.php'; ?>
    ...
    <div class="relative bg-slate-900 text-white py-24 overflow-hidden border-b border-slate-800 text-center">
        ...
        <div class="absolute inset-0 z-0 pointer-events-none">
            <img src="assets/banner_slide_1.png" alt="About Journal" class="w-full h-full object-cover object-center opacity-30 scale-105 filter blur-[1px]">
        ...
        <div class="container mx-auto px-6 relative z-10">
            <nav class="flex justify-center mb-6 text-sm font-semibold text-emerald-400" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-2">
                    ...
                    <li aria-current="page" class="text-white">IJARI > About Journal</li>
                </ol>
            </nav>
            <h1 class="text-4xl md:text-5xl font-bold mb-4 font-['Outfit'] tracking-tight text-white drop-shadow-md">About Journal</h1>
            <p class="text-lg md:text-xl text-slate-300 max-w-3xl mx-auto font-light leading-relaxed drop-shadow">Advancing scientific knowledge and fostering innovation across diverse fields of agriculture.</p>
        </div>
    </div>
            ...
            <div class="grid lg:grid-cols-3 gap-10">
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-3xl shadow-sm border border-slate-100 p-8 md:p-10 prose prose-emerald prose-lg max-w-none text-slate-600">
                        ...
                        <p>By embracing this multidisciplinary scope, the journal reflects the increasingly interconnected nature of modern agricultural research and its critical role in addressing global challenges such as food security, climate resilience, and sustainable resource management.</p>
                        
                        <h3 class="font-['Outfit'] text-2xl font-bold text-slate-900 mt-10 border-b border-slate-100 pb-2">Aims & Scope</h3>
                ...
                <div class="lg:col-span-1 space-y-6">
                    <div class="bg-emerald-50 rounded-2xl p-6 border border-emerald-100">
                        <div class="w-12 h-12 bg-white text-emerald-600 rounded-full flex items-center justify-center text-xl shadow-sm mb-4"><i class="fas fa-calendar-check"></i></div>
                        <h4 class="font-bold text-lg text-emerald-900 mb-2 font-['Outfit']">Publication Frequency</h4>
                        <p class="text-emerald-800/80 text-sm">International Journal of Agriculture Research and Innovation is published <strong>quarterly</strong>.</p>
                    </div>
                    
                    <div class="bg-slate-900 rounded-2xl p-6 border border-slate-800 text-white shadow-xl">
                        <div class="w-12 h-12 bg-emerald-500/20 text-emerald-400 rounded-full flex items-center justify-center text-xl mb-4"><i class="fas fa-lock-open"></i></div>
                        <h4 class="font-bold text-lg mb-2 font-['Outfit']">Open Access Policy</h4>
