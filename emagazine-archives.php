...
?><?php include 'header.php'; ?>
    ...
    <div class="relative bg-slate-900 text-white py-24 overflow-hidden border-b border-slate-800 text-center">
        ...
        <div class="absolute inset-0 z-0 pointer-events-none">
            <img src="assets/banner_slide_3.png" alt="Magazine Archives" class="w-full h-full object-cover object-center opacity-30 scale-105 filter blur-[1px]">
        ...
        <div class="container mx-auto px-6 py-20 max-w-4xl">
            <?php if (empty($magazineArticles)): ?>
                <div class="py-20 bg-white rounded-3xl shadow-sm border border-slate-100 text-center flex flex-col items-center">
                    <div class="w-24 h-24 bg-slate-50 rounded-2xl rotate-3 flex items-center justify-center mb-6 border border-slate-200">
