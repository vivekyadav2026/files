...
<div class="relative bg-emerald-50 text-emerald-950 py-12 md:py-16 overflow-hidden border-b border-emerald-100 text-center">
        ...
        <div class="absolute inset-0 z-0 pointer-events-none">
            <img src="assets/light_banner_v2.png" alt="Publication Policies & Ethics" class="w-full h-full object-cover object-center opacity-40 ">
        ...
        <div class="container mx-auto px-6 relative z-10">
            <nav class="flex justify-center mb-6 text-sm font-semibold text-emerald-600" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-2">
                    ...
                    <li aria-current="page" class="text-emerald-950 font-semibold">IJARI > Policies & Ethics</li>
                </ol>
            </nav>
            <h1 class="text-4xl md:text-5xl font-bold mb-4 font-['Outfit'] tracking-tight text-emerald-900">Publication Policies & Ethics</h1>
            <p class="text-lg md:text-xl text-slate-600 max-w-3xl mx-auto font-light leading-relaxed">Upholding internationally recognized standards of publishing.</p>
        </div>
    </div>
